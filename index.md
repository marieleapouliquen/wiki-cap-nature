    ...
    <div class="page-content">
      ...
      <section class="content">
        ...
        <div class="callout tip">
          <div class="callout-title">Trois intentions</div>
          <p>Prêter <strong>attention</strong> au vivant proche ; <strong>expérimenter</strong> par des instruments scientifiques accessibles ; et <strong>réfléchir</strong> à notre cohabitation avec les autres espèces.</p>
        </div>
        ...
        <div class="card-grid">
          <a class="card" href="{{ '/module-oiseaux/' | relative_url }}">
            ...
            <span class="btn">Découvrir le module →</span>
          </a>
