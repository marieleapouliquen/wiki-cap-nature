...
<section class="section-full-bleed band-white section-pad">
  <div class="container">
    <div class="page-content">
      ...
      <h2 id="definition">Qu'est-ce qu'un paysage sonore ?</h2>
      ...
      <div class="concept-grid">
        <div class="concept-card">
          ...
          <p>Les manifestations sonores des êtres vivants non-humains (chants d'oiseaux, coassements d'amphibiens, stridulations d'insectes, mammifères).</p>
        </div>
        <div class="concept-card">
          <strong>Géophonie</strong>
          <p>Les sons de la nature non vivante, liés aux éléments naturels et à la météo (souffle du vent, clapotis de la pluie, grondement des rivières).</p>
        </div>
        <div class="concept-card">
          <strong>Anthrophonie</strong>
          <p>L'ensemble des bruits produits par l'activité humaine et le développement des infrastructures (paroles, moteurs, machines, circulation).</p>
        </div>
      </div>

      <details id="interet" class="disclosure">
        <summary>
          <span class="disclosure-title">Pourquoi étudier les paysages sonores ?</span>
      ...
      <details id="bienfaits" class="disclosure">
        <summary>
          <span class="disclosure-title">Les bienfaits des sons de la nature</span>
          <span class="disclosure-hint">(Cliquez pour déplier)</span>
        </summary>
        <div class="disclosure-body">
