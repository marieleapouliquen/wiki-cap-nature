...
<h3>1. Préparation et installation du matériel (En amont)</h3>
  <p>Avant d'accueillir les participants, assurez-vous du bon paramétrage des outils pour éviter les blocages techniques sur le terrain :</p>
  <ul>
    <li><strong>Vérification de la batterie des paraboles :</strong> </li>
    <li><strong>Câblage :</strong> Préparez les câbles de liaison adaptés à chaque téléphone (prises Jack, adaptateurs USB-C ou connecteurs Lightning).</li>
    <li><strong>Kit d'écriture :</strong> Rassemblez les fiches d'observation imprimées.</li>
  </ul>

  <h3>2. Mise en contexte et constitution des groupes et distribution des rôles</h3>

Pour la mise en contexte, quelques idées : 
  ...
  <h3>3. L'exploration sur le terrain</h3>
